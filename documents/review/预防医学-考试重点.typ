...
- *生物放大*：污染物随食物链在高位营养级生物体内浓度逐级放大的现象（如DDT放大100万倍）。
...
- *合理营养*：指全面而平衡的营养。
- *植物化学物*：指多在植物性食物中存在的、已知必需营养素以外的具有生物活性的化学成分。
- *营养素的需要量和供给量*：也称"生理需要量"，指能保持人体健康，达到应有发育水平并能充分发挥效率完成体力和脑力活动，人体所需要的热能和各种营养素的必需量。
- *EAR（平均需要量）*：满足人群中50%个体需要量的摄入水平。
- *RNI（推荐摄入量）*：满足人群中97%~98%个体需要量的摄入水平，是营养目标值。
- *AI（适宜摄入量）*：不能确定RNI时，通过观察或实验获得的健康人群某种营养素的摄入量。
- *UL（最高可耐受摄入量）*：平均每日摄入营养素的最高限量，对几乎所有个体不致引起健康损害。

// 注：第4章"食品卫生"部分老师未讲授，故不列入名词解释。
...
> 室内空气污染相关名词解释见"名词解释（按章节整理）"章节。
> 常见室内空气污染名词解释（2个，与室外略有区别）：
...
*额外重点*：
1. *介水传染病*：通过饮用或接触受病原体污染的水，或食用被水污染的食物而传播的疾病（需与传染病章节结合）
2. *消毒*：杀灭外环境中病原微生物的方法，使水质符合饮用水各项细菌学指标的要求，防止介水传染病的发生和传播，维护人群健康
  - 消毒方法：Cl₂、ClO₂、紫外线、臭氧
3. *生活饮用水基本要求*（5条）：
  + 生活饮用水中不得含有病原微生物
  + 生活饮用水中化学物质不得危害人体健康
...
> 职业性、职业性有害因素的名词解释见"名词解释（按章节整理）"章节。
...
#figure(
  table(
    ...
    table.header([职业病], [典型临床表现], [治疗方法], [备注]),
...
*营养学计算题*：
- > 摄入量相关4个值（EAR、RNI、AI、UL）的名词解释见"名词解释（按章节整理）"章节。
- 能量换算（必须记住）：
...
- *糖尿病*：诊断标准——空腹血糖 ≥7.0 mmol/L，或餐后2小时血糖 ≥11.1 mmol/L，或 HbA1c ≥6.5%
- 血糖正常值范围：空腹血糖 3.9～6.1 mmol/L；餐后2小时血糖 \<7.8 mmol/L
